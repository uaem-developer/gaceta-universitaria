...
<section class="main-content">
    <div class="searchbox large-6 columns">
        ...
        <div>
            ...
            <ul>
                <li><div class="large-5 columns"><span class="gaceta-numero"> 433</span>Ene 2015</div>
                    <div class="large-11 columns">
                        <strong>En portada</strong>
                        <a href="#">Arranca la obra del claustro universitario en Axochiapan </a>
                        <div class="author">Por Salvador Rivera <br/>Enero 6, 2015| Gaceta No 433 Gestión</div>
        ...
        <div>
            <h2>Galeria</h2>
            <figure class="large-4 columns"><img src="../img/galeria-thumb.jpg" alt=""/></figure>
            <figure class="large-4 columns"><img src="../img/galeria-thumb2.jpg" alt=""/></figure>
            <figure class="large-4 columns"><img src="../img/galeria-thumb.jpg" alt=""/></figure>
            <figure class="large-4 columns"><img src="../img/galeria-thumb2.jpg" alt=""/></figure>
        </div>
    </div>
    <div class="large-10-columns">
        ...
        <div class="large-9 columns">
            <h3>Primer piedra del claustro universitario en Miacatlán</h3>
            <div class="fecha-post">Enero 6 2015|Gaceta N o433</div>
            <figure><img src="../interiores.jpg" alt=""/></figure>
